use backend::features::documents::models::{
    Collection, Document, DocumentInCollection, Property, Row,
};
use tauri::State;
...
#[tauri::command]
pub async fn create_row(state: State<'_, AppState>, collection_id: String) -> Result<Row, String> {
