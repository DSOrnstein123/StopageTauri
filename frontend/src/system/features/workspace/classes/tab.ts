import { createTabStore, type TabStore } from "../stores/tabStore";
...
import { resolveEntryType } from "../utils/resolveEntryType";
import { entryFactory } from "@system/registries/entryFactory";
import { EntryRuntime } from "@system/registries/entryRuntime";
